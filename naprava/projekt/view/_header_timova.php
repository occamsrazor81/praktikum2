...
<body>
  ...
  <p>
    ...
    League: <span id="ln"><?php if(isset($_SESSION['league_title']) )  echo $_SESSION['league_title']; ?></span>
  </p>
	...
	<nav>
      ...
      <li><a class="link" href="index.php?rt=teams/usersInLeague">Users in League</a></li>
			<li><a class="link" href="index.php?rt=teams/startDraft">Start Draft</a></li>
		</ul>
	</nav>
